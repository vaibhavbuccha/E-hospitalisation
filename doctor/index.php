    ...
    <div>
        <div align="center" class="phone">
            <div align=center class="outer">
                <div class="inner">
                <img class="img" src="images/site.jpg">
                <div class="login-box">
                <?php
   ...
   if(isset($_POST['login']))
    {
        ...
        if(count($errors)==0)
        {
            $sql = "SELECT * FROM doctor WHERE name ='".$username."'AND password='".$password_1."' LIMIT 1";
...
?>
                    <table align="center">
                        <form action="#" method="post">
                            ...
                            <p class="s"><span>Doctor Pannel</span><br><span class="s1">ARNHO</span><span class="s2">SPITAL</span></p>
                            </tr>
